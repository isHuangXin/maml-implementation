...
class MiniImagenet(Dataset):
    ...
    root:
       |- images/*.jpg includes all imageas
       |- train.csv
       |- test.csv
       |- val.csv
    NOTICE: meta-learning is different from general supervised learning, especially the concept of bath and set
    ...
    def __getitem__(self, index):
        ...
        print('global:', support_x, query_y)
        # support_y: [setsz]
        # query_y: [querysz]
        # unique: [n-way], sorted
